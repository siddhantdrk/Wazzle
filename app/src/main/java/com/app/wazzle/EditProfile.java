...
public class EditProfile extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        colorsName.add("Purple");

        ArrayList<String> colorsCode = new ArrayList<>();
        colorsCode.add("#FFFFFF");
        colorsCode.add("#000000");
        colorsCode.add("#808281");
        colorsCode.add("#FAE80A");
        colorsCode.add("#CF2333");
        colorsCode.add("#2E63AF");
        colorsCode.add("#0D8142");
        colorsCode.add("#80592E");
        colorsCode.add("#F8CDE0");
        colorsCode.add("#F26945");
        colorsCode.add("#4D3291");
